...
function sidebarColor(e) {
    ...
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"), document.querySelector(".sidenav").setAttribute("data-color", a), document.querySelector("#sidenavCard") && (e = ["btn", "btn-sm", "w-100", "mb-0", "bg-gradient-" + a], (a = document.querySelector("#sidenavCard+.btn")).removeAttribute("class"), a.classList.add(...e))
}
...
function navbarColorOnResize() {
    sidenav && (1200 < window.innerWidth ? referenceButtons.classList.contains("active") && "bg-default" === referenceButtons.getAttribute("data-class") ? sidenav.classList.remove("bg-white") : body.classList.contains("dark-version") || sidenav.classList.add("bg-white") : (sidenav.classList.add("bg-white"), sidenav.classList.remove("bg-default")))
}
